...
srun jupyter nbconvert --execute --to notebook --inplace ./diffuser/StableDiffusion_LoRA.ipynb

# scp -r ./sleep-stablediffusion-lora.sh e1503329@xlogin.comp.nus.edu.sg:/home/e/e1503329/abhishek/diffusion_generator_code
# scp -r ./StableDiffusion_LoRA.ipynb e1503329@xlogin.comp.nus.edu.sg:/home/e/e1503329/abhishek/diffusion_generator_code/diffuser
