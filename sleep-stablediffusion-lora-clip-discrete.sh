...
srun jupyter nbconvert --execute --to notebook --inplace ./diffuser/StableDiffusion_LoRA_CLIP_discrete.ipynb

# scp -r ./sleep-stablediffusion-lora-clip-discrete.sh e1503329@xlogin.comp.nus.edu.sg:/home/e/e1503329/abhishek/diffusion_generator_code
# scp -r ./StableDiffusion_LoRA_CLIP_discrete.ipynb e1503329@xlogin.comp.nus.edu.sg:/home/e/e1503329/abhishek/diffusion_generator_code/diffuser
